...
文字按钮在现在有了全新的设计样式。`type='text'`兼容了老版样式<el-tag round effect="plain" size="small">2.2.0</el-tag> 的按钮，后续新的文字按钮推荐使用 [Link](./link.md#basic) 组件。
...
| type                                | 类型                           | string             | primary / success / warning / danger / info / <span style="color: #f56c6c">text(不推荐,请使用 [Link](./link.md#basic) 组件)</span> | —       |
